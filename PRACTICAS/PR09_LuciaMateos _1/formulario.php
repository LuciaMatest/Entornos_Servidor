    ...
    <main>
        ...
        <form action="./formulario.php" method="post" enctype="multipart/form-data">
            ...
            <p>
                ...
                <input type="password" name="password" id="idContraseña"
                value="<?
                    //Mantener el texto introducido en el campo de texto 
                    if (enviado() && !vacio("password")) {
            ...
            <p>
                <!-- SUBIR IMAGEN -->
                <label for="idFichero">Subir imagen:</label>
                <input type="file" name="fichero" id="idFichero">
                <?
                    //comprobar que existe y del formato adecuado, si lo está pongo un error
                    if (enviado()) {
                        if (!file_exists($_FILES['fichero']['tmp_name'])) {
                            ?>
                            <span style="color:brown"> No existe fichero</span>
                            <?
                        } elseif (!patronFichero()) {
                            ?>
                            <span style="color:brown"> Fichero no válida, revise</span>
                            <?
                        }
                    }
                ?>
