            ...
            <div class="col-md-12">
                <div class="row g-0 rounded overflow-hidden flex-md-row mb-4 h-md-250 position-relative">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-4 d-block d-lg-block">
                        <img src='./webroot/imagen<? echo $producto->imagen_alta ?>'>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-8 p-4 d-flex flex-column position-static">
                        ...
                        <form action="./index.php" method="post">
                            <div class="form-group">
                                ...
                                <input type="number" class="border-gray" name="cantidad" value="1" title="Cantidad" size="4" min="1" max="<? echo $producto->cantidad ?>">
                            </div>
                            <div class="form-group pt-2">
                                <div class="input-group w-50">
                                    <span class="input-group-text" style="background-color: #be901b;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16" style="color: white;">
                                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" />
                                        </svg>
                                    </span>
                                    <input type="submit" value="Comprar" name="comprar" class="botonG" style="border-top-right-radius: 5px; border-bottom-right-radius: 5px;">
                                </div>
                                <input type="hidden" name="cod_producto" value="<? echo $producto->cod_producto ?>">
                            </div>
                        </form>
                        <div class="alert border-none alert-warning mt-4 " style="font-weight: bold; color: #555; font-size:80%">
